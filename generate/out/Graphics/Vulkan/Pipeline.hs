...
import Graphics.Vulkan.Shader( VkShaderModule(..)
...
-- ** VkPipelineDepthStencilStateCreateFlags-- | Opaque flag
...
-- ** VkPipelineColorBlendStateCreateFlags-- | Opaque flag
...
-- ** VkPipelineInputAssemblyStateCreateFlags-- | Opaque flag
...
-- ** VkPipelineViewportStateCreateFlags-- | Opaque flag
...
-- ** VkPipelineRasterizationStateCreateFlags-- | Opaque flag
...
-- ** VkPipelineDynamicStateCreateFlags-- | Opaque flag
...
-- ** VkPipelineShaderStageCreateFlags-- | Opaque flag
...
-- ** VkPipelineTessellationStateCreateFlags-- | Opaque flag
...
-- ** VkPipelineVertexInputStateCreateFlags-- | Opaque flag
...
newtype VkSampleMask = VkSampleMask Word32
  deriving (Eq, Ord, Storable, Show)
-- ** VkPipelineMultisampleStateCreateFlags-- | Opaque flag
